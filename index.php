...
$varpath = "http:/www.tudominio.com/index.php?image=";
$varstat = "";
...
<title>PHP ImageHosting</title>
<link href="cssupload.css" rel="stylesheet" type="text/css" />
</head>
<body>
<table width="420" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="413" height="40" class="titulo">Image Hosting PHP </td>
  </tr>
  <tr>
    <td class="text">Script basado en Php</td>
  </tr>
  <tr>
